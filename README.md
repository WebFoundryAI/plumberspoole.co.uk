...
1. Clone the repository:
   ```bash
   git clone https://github.com/WebFoundryAI/plumberspoole.co.uk.git
   cd plumberspoole.co.uk
   ```
...
4. Click **Save**
5. Site will be live at: `https://webfoundryai.github.io/plumberspoole.co.uk/`
